//! Procedural world generation for Qwencraft.
//!
...
/// Client terrain-pool capacities (shared with `qwencraft-client`). These
...
/// are sized by `qwencraft-server/examples/pool_measure.rs` from a multi-
